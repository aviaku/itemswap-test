                        ...
                        {Array(16)
                          ...
                          .map((_, i) => (
                            <div className="inline-flex justify-center items-center w-[68px] flex-col gap-[4px] overflow-hidden cursor-pointer">
                              ...
                              <span className="ellipsis !w-full text-center text-[12px] leading-none text-[#999]">
                                8-bit
                              </span>
                            </div>
                          ))}
            ...
            <div className="flex flex-col gap-[16px]">
              <div>
                {Array(7)
                  .fill()
                  .map((_, i) => (
                    <div className="flex flex-col gap-[1px] border border-[#323232] bg-[#323232] mb-4">
                      <header className="relative flex flex-col justify-between gap-[16px] bg-[#2D2F37] py-[16px] pl-[16px] pr-[54px] lg:min-h-[50px] lg:flex-row lg:items-center lg:py-[12px] lg:pr-[16px]">
                        <div className="inline-flex flex-col flex-wrap gap-[8px] md:flex-row md:items-center md:gap-[4px]">
                          <strong className="text-[14px] font-semibold leading-none text-white">
                            Jazz MissFortune
                          </strong>
                          <span className="text-[12px] leading-none text-[#999]"></span>
                        </div>
                        <div className="inline-flex flex-shrink-0 gap-[22px]">
                          <div className="inline-flex flex-wrap gap-[2px]">
                            {Array(7)
                              .fill()
                              .map((_, i) => (
                                <div
                      ...
                      <div className={`${isClosed[i] ? "hidden" : ""}`}>
                        <div
                          className="flex flex-col bg-center bg-no-repeat"
                          style={{
                            backgroundImage: `url(${cardBg.src})`,
                          }}
                        >
                          <div className="flex min-h-[150px] flex-col items-center bg-[#27282E] py-[16px] lg:flex-row lg:gap-[33px] lg:bg-transparent lg:px-[8px] lg:py-[0px] xl:pl-[164px] xl:pr-[24px]">
                            <div className="mb-[16px] max-w-[342px] lg:mb-0 lg:w-full lg:max-w-[456px] lg:flex-shrink-0">
                              <div
                                ...
                                {Array(7)
                                  ...
                                  .map((_, i) => (
                                    <div
                                      ...
                                      style={{ gap: "4px" }}
                                    >
                                      <div className="inline-flex items-center justify-center relative flex-col pt-[14px]">
                                        ...
                                        <div className="relative inline-flex flex-col">
                                          <div className="relative flex flex-col w-[34px] h-[34px] md:w-[50px] md:h-[50px] rounded-[6px]">
                                            <div className="relative inline-flex overflow-hidden rounded-[6px] border-2">
                                              <img
                                                src={chineseWeapon.src}
                                          ...
                                          <p
                                            className="ellipsis text-center text-[11px] leading-[14px] text-[#808080] font-extralight absolute bottom-0 left-0 w-full p-[2px] m-0"
                                            style={{
                            ...
                            <div className="mb-[20px] grid w-full grid-cols-3 md:grip-cols-4 gap-[4px] sm:w-auto md:mb-0 md:!flex md:items-center">
                              ...
                              <div className="flex h-[98px] flex-col justify-between rounded-[4px] bg-[#1D1D1D] py-[12px] sm:w-[126px]">
                              ...
                              <div className="ml-[26px] hidden items-center justify-center lg:flex">
                                <a
                                  target="_blank"
