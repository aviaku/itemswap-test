    ...
    datasets: [
      {
        ...
        backgroundColor: "rgba(54, 162, 235, 1)", // Uniform color for all bars
        borderColor: "rgba(54, 162, 235, 1)", // Uniform color for all bar borders
        borderWidth: 1,
      },
    ],
  };
                          ...
                          {traits
                            ...
                            ?.map((trait, i) => (
                              ...
                              >
                                ...
                                <span className="ellipsis !w-full text-center text-[16px] leading-none text-[#cccccc]">
                                  {trait?.name}
                                </span>
                              </div>
                            ))}
                            ...
                            >
                              {metaDeck?.deck?.champions
                                ...
                                .map((champion, i) => (
                                  ...
                                  >
                                    <p
                                      className="ellipsis text-center text-[11px] md:text-[18px] leading-[14px] text-[#808080] font-extralight
                                           w-full p-[2px] m-0"
                                      style={{
